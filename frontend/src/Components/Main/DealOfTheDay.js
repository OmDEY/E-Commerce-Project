...
const dealData = [
    { id: 1, name: 'Simply Lemonade', image: 'https://via.placeholder.com/400x300', rating: 4.5, description: 'Refreshing lemonade with a hint of lemon.', company: 'Simply Beverages' },
    { id: 2, name: 'Raspberry Juice', image: 'https://via.placeholder.com/400x300', rating: 4.7, description: 'Sweet and tangy raspberry juice.', company: 'Raspberry Delights' },
    { id: 3, name: 'Orange Punch', image: 'https://via.placeholder.com/400x300', rating: 4.2, description: 'Zesty orange punch with a burst of flavor.', company: 'Citrus Creations' },
    { id: 4, name: 'Grape Fusion', image: 'https://via.placeholder.com/400x300', rating: 4.6, description: 'Delicious grape fusion with a smooth finish.', company: 'Grape Goodness' },
];
