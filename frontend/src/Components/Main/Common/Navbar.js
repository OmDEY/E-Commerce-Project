            ...
            <div className="bg-white shadow p-4">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="flex items-center border border-gray-300 rounded-full overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out w-full md:w-1/2 lg:w-1/3">
                        ...
                        />
                        <button className="flex items-center justify-center bg-pink-500 text-white p-3 transition-all duration-300 hover:bg-pink-600 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-pink-600">
