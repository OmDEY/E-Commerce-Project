...
import { FaStar, FaTruck, FaDollarSign, FaCalendarAlt, FaShieldAlt, FaArrowLeft, FaArrowRight } from 'react-icons/fa';
    ...
    moreDetails: [
        {
            ...
            description: 'Detailed view of the product with extra features highlighted.',
        },
        {
            image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjnIwY2c_pLXybmoSDikwCF6hehjs0xb6UzQ&s',
...
const SingleProductDisplay = () => {
    ...
    const [reviews, setReviews] = useState([
        ...
        { id: 2, name: 'Jane Smith', rating: 5, comment: 'Loved it, will buy again.' },
        { id: 3, name: 'Alice Brown', rating: 3, comment: 'Good, but could be better.' },
    ]);
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
                <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="mt-4 flex space-x-4">
                            {product?.images?.map((img, idx) => (
                                <img
                                    ...
                                    className={`w-20 h-20 cursor-pointer rounded-lg transition-transform transform hover:scale-110 ${mainImage === img ? 'border-4 border-blue-500' : ''
                                        }`}
                    ...
                    <div className="lg:ml-8 lg:w-1/2">
                        ...
                        <p className={`text-xl font-bold mb-4 ${product.stock ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative bg-gray-50 p-4 rounded-lg mb-4">
                                ...
                                <div className="flex overflow-x-auto space-x-4">
                                    ...
                                    <div className="min-w-[200px] bg-white p-4 rounded-lg shadow-md">
                                        <p>Bank Offer: Upto ₹1,500.00 discount on select Credit Cards</p>
                                    </div>
                                    <div className="min-w-[200px] bg-white p-4 rounded-lg shadow-md">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex space-x-4">
                                <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">S</button>
                                <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">M</button>
                                <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">L</button>
                                <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">XL</button>
                            </div>
                        </div>

                        {/* Add to Cart Button */}
                        <button className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600">Add to Cart</button>
                    </div>
                </div>
                ...
                <div className="mt-12 bg-white p-8 rounded-lg shadow-lg transition-transform transform hover:scale-105">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-200">
                                ...
                                <tr className="bg-gray-100">
                                    ...
                                    {comparisonData.map((item, index) => (
                                        <th key={index} className="border border-gray-300 px-4 py-2 text-center">
                                            <img src={item.image} alt={item.name} className="w-24 h-24 object-cover mx-auto rounded-lg shadow-md" />
                            ...
                            <tbody>
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 font-semibold">Brand</td>
                                    {comparisonData.map((item, index) => (
                                        <td key={index} className="border border-gray-300 px-4 py-2 text-center">{item.brand}</td>
                                    ))}
                                </tr>
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 font-semibold">Price</td>
                                    {comparisonData.map((item, index) => (
                                        <td key={index} className="border border-gray-300 px-4 py-2 text-center">${item.price}</td>
                                    ))}
                                </tr>
                                <tr>
                                    <td className="border border-gray-300 px-4 py-2 font-semibold">Rating</td>
                                    {comparisonData.map((item, index) => (
                                ...
                                <tr>
                                    ...
                                    {comparisonData.map((item, index) => (
                                        <td key={index} className="border border-gray-300 px-4 py-2 text-center">{item.features}</td>
                                    ))}
                                </tr>
                            </tbody>
                        </table>
